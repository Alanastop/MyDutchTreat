...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__orderList_orderList_component__ = __webpack_require__("./ClientApp/app/orderList/orderList.component.ts");
...
var routes = [
    ...
    { path: "orderHistory", component: __WEBPACK_IMPORTED_MODULE_9__orderList_orderList_component__["a" /* OrderList */] }
];
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__orderList_orderList_component__["a" /* OrderList */]
            ],
            imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__order__ = __webpack_require__("./ClientApp/app/shared/order.ts");
...
var DataService = /** @class */ (function () {
    function DataService(http) {
        this.http = http;
        this.token = "";
        this.order = new __WEBPACK_IMPORTED_MODULE_1__order__["a" /* Order */]();
        this.products = [];
        this.orders = [];
    }
    ...
    DataService.prototype.checkout = function () {
        ...
        return this.http.post("http://localhost:50939/api/orders", this.order, {
            ...
            .map(function (response) {
            _this.order = new __WEBPACK_IMPORTED_MODULE_1__order__["a" /* Order */]();
            return true;
        });
    };
    ...
    DataService.prototype.AddToOrder = function (product) {
        ...
        if (item) {
            ...
            item = new __WEBPACK_IMPORTED_MODULE_1__order__["b" /* OrderItem */]();
